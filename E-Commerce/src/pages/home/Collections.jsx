...
const Collections = () => {
  return (
    <div className='bg-[url("/images/brands/collection-bg.png")] bg-cover bg-center bg-no-repeat xl:px-28 px-4 my-20'>
      <div className=" h-[580px]  flex justify-betweenflex-col md:flex-row items-center">
        <div className="md:w-1/2"></div>
        <div className="md:w-1/2">
          <img src="/public/images/brands/zara-logo.png" alt="photo" className="md:w-40" />
